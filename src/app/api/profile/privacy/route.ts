  ...
  try {
    ...
    await db
      ...
      .values({
        ...
        showEmployer: next.showEmployer,
        ...
        receiveMentorshipNotifications: next.receiveMentorshipNotifications,
        receiveDonationCampaignUpdates: next.receiveDonationCampaignUpdates,
